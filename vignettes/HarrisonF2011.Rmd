...
You can physcially pool to a single row (and multiple columns) or a single row and single column (which is equivalent to the pooled Petersen estimator).
...
Note that the estimates from physcial and logical pooling are the same.
