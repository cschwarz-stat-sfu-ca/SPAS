...
```
A total of $149+126+1561=1836$ fish were tagged and released in week 1. Of these fish, $149$ were recovered downnstream in column stratum 1;
...
The Stratified-Petersen model is fit to the above data object. We relax the convergence criteria because of the very sparse data 
in row 6 implies that the likelihood will be very flat. The code to fit the model is:
```{r fit1,results="hide"}
